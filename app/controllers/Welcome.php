...
class Welcome extends Controller {
	...
	public function email(){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'rence.quinio12@gmail.com';  
        $mail->Password = 'uxax ilpr isbf fcgk'; 
	...
	public function sendVerificationEmail($to, $verificationCode) {
		...
		$from = 'rence.quinio12@gmail.com'; 
		$mail->setFrom($from, 'Quinio'); 
		$mail->addAddress( $to);  
		// var_dump($email);
		$mail->isHTML(true);
...
//logim register.................................................
	...
	public function rooms(){
		...
		$this->call->view('user/Rooms', $data);
	}
	public function about(){
		$this->call->view('user/About');
	}
	public function home_details(){
		$this->call->view('user/Homedetails');
	}
	public function blog(){
		$this->call->view('user/Blog');
	}
	public function details(){
		$this->call->view('user/BlogDetails');
	}
	public function adminhome(){
		$this->call->view('admin/adminhome');
	}
	public function allbooking(){
		$this->call->view('admin/all_booking');
	}
	public function addrooms(){
		$this->call->view('admin/addrooms');
	}
